...
def get_arguments():
    ...
    ## [Training] Different weights of loss
    parser.add_argument(
        '--disc_loss_weight',
        type=float,
        default=1,  #0.13,
    ...
    parser.add_argument(
        ...
        help="Type of discriminator: conv (fully convolution)"
        "or normal (with fc layers). Default is conv.",
        choices=['conv', 'normal'])
    ...
    parser.add_argument(
        '--plot_all',
        action='store_true',
        help='whether to plot sequence of all images. Only in testing')
    parser.add_argument(
        '--plot_last_vf',
        action='store_true',
        help='whether to plot last vector field. Only in testing')
    ...
    parser.add_argument('--data',
                        ...
                        default="mnist_warp",
                        help='Possible data')
    parser.add_argument('--n_files_read',
                        type=int,
                        default=100,
                        help='When loading files, how many should be loaded')
